...
#pragma config WDT      = OFF       // WatchdogTimer desligado
#pragma config MCLRE    = OFF       // Master Cleardesabilitado
*/
...
void Configura(void)
{
   //OSCCON = 0x72;   // Oscilador interno de 8Mhz   0b01100000
   OSCCON = 0b01100000; // 4Mhz
   ADCON1 = 0x0F;  // Configura as portas como digitais
 ...
 * Rotina necessária para o compilador XC8 saber onde é o início do vetor de "reset".
