...
void Delay10us( unsigned long tenMicroSecondCounter )
{
    ...
    else
    {
        ...
        cyclesRequiredForEntireDelay = (long)(12000000/100000) * tenMicroSecondCounter;
        ...
        else
        {
            ...
            {
                __nop();
                cyclesRequiredForEntireDelay -= 42;
            }
        }
    }
}
...
void DelayMs( unsigned short int ms )
{
        ...
        cyclesRequiredForEntireDelay = (signed long)(12000000/1000) * ms;
        ...
        else
        {
            ...
            {
                __nop();
                cyclesRequiredForEntireDelay -= 39;
            }
        }
}
