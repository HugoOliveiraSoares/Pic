...
#include <pwm.h>    // Necessário para que o modo PWM funcione
#include <timers.h>// Necessário porque o PWM usa o timer2
...
void main(void)
{
	...
	while (1)
	{
            // Função que determina o valor do Duty Cycle, 0 a 1023
...
void ConfiguraSistema (void)
{
	// Desabilita todas as 13 portas analógicas ANx
	...
	OpenTimer2( TIMER_INT_OFF & T0_PS_1_16 ) ;
        ...
        // Função que habilita e configura a frequencia do PWM, 0 a 255
