...
#include "displayLCD_nano.h"    // Biblioteca desenvolvida pela sempra,
                                // com adaptações feitas para uso exclusivo
                                // da plataforma E-Duino Nano
...
//				1 = LED ligado
#define LED_AMARELO	LATCbits.LATC0
...
void main(void)
{
	...
	LimpaDisplay();
	DesligaCursor();
        // De acordo com a função, cria os 5 primeiros caracteres da variavel robo
...
void ConfiguraSistema (void)
{
	...
	// Configura LED do Kit SEMPRA E-Duino Nano: saida digital
	TRISCbits.TRISC1=0;		// RC1: saida digital - LED_AMARELO
	TRISCbits.TRISC0=0;             // RC0: saida digital - LED_AMARELO

	// Configura Botão do Kit SEMPRA E-Duino Nano: entradas digital
