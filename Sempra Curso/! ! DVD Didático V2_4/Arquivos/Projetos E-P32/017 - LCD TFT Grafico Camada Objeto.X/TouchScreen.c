...
volatile SHORT adcPot   = 1023;
volatile SHORT adcLdr   = 1023;
volatile SHORT adcTemp   = 1023;
...
static const XCHAR scr1StrLn1[] = "IMPORTANTE:";
static const XCHAR scr1StrLn2[] = "Tela de calibracao do";
static const XCHAR scr1StrLn3[] = "touchscreen:";
static const XCHAR scr1StrLn4[] = "Toque exatamente nas posicoes";
static const XCHAR scr1StrLn5[] = "indicadas pelas setas.";
static const XCHAR scr1StrLn6[] = "Toque na tela para continuar";
...
********************************************************************/
void TouchGetCalPoints(void){
static const XCHAR calStr[] = "Calibracao";
XCHAR calTouchLeft[] = "3 toques na restantes";
SHORT counter;
SHORT x,y;
WORD  ax[3],ay[3];
