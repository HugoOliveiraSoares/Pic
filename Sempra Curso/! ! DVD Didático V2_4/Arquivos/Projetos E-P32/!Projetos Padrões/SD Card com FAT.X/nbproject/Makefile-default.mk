...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/0013_-_SDCARD_FAT.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Delays.o ${OBJECTDIR}/Demonstration.o "${OBJECTDIR}/MDD File System/FSIO.o" "${OBJECTDIR}/MDD File System/SD-SPI.o"
POSSIBLE_DEPFILES=${OBJECTDIR}/Delays.o.d ${OBJECTDIR}/Demonstration.o.d "${OBJECTDIR}/MDD File System/FSIO.o.d" "${OBJECTDIR}/MDD File System/SD-SPI.o.d"

# Object Files
OBJECTFILES=${OBJECTDIR}/Delays.o ${OBJECTDIR}/Demonstration.o ${OBJECTDIR}/MDD\ File\ System/FSIO.o ${OBJECTDIR}/MDD\ File\ System/SD-SPI.o
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/0013_-_SDCARD_FAT.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/Demonstration.o: Demonstration.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/Demonstration.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/Demonstration.o.d" -o ${OBJECTDIR}/Demonstration.o Demonstration.c  
...
${OBJECTDIR}/Demonstration.o: Demonstration.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/Demonstration.o.d 
	@${FIXDEPS} "${OBJECTDIR}/Demonstration.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/Demonstration.o.d" -o ${OBJECTDIR}/Demonstration.o Demonstration.c  
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/0013_-_SDCARD_FAT.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)    -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/0013_-_SDCARD_FAT.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}        -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__ICD2RAM=1,--defsym=__DEBUG=1 
else
dist/${CND_CONF}/${IMAGE_TYPE}/0013_-_SDCARD_FAT.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/0013_-_SDCARD_FAT.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}        -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION)
	${MP_CC_DIR}\\pic32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/0013_-_SDCARD_FAT.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  
endif
