 ...
 *						
 *						
 * Descrição:   	Exemplificar o uso de entrada digital, realizando a leitura
 *			de um valor em uma porta do PIC. Utilzar defines para 
 *			facilitar e deixar mais intuitivo o uso. 
 * 			Ler o estado do Botão, que está ligado à porta RA3 dos 
 *			respectivos PIC18F4550 e PIC 18F2550. Utilizar estrutura
 *			de decisão ( if - else ) para alternar os estados dos leds
 *			de acordo com o botão pressionado ou não.
 *
 *****************************************************************************/
