/******************************************************************************
 *
 *             SEMPRA PROJETOS EXEMPLOS (PIC18F4550)
 *
 ******************************************************************************
 ...
 * Empresa:         	SEMPRA
 *
 * Plataforma:		KIT E-P18 V 3.6
 * Prática:	 	Liga LED
 * Descrição:        	Liga o LED verde do KIT E-P18 que esta conectado no
 *			pino RC2 do PIC18F4550.
 *****************************************************************************/
...
void ConfiguraSistema (void)
{
	...
	TRISCbits.TRISC2 = 0;	// RC2: ligado ao LED verde
